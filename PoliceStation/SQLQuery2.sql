...
-------------------------------- 
--insert into PoliceCars(PSid,car_number,model,serial_number)
--values(1,'CJ04ABC','model1',1),(2,'CJ17AAA','model2',2),(1,'CJ99DLC','model3',3),(2,'CJ12ALC','model4',4),(1,'CJ04OPA','model2',5),
--(1,'CJ78CVA','model5',6),(2,'CJ84AZI','model2',7),(4,'CJ10MOR','model4',8),(3,'CJ05CAF','model3',9);

--DELETE
--FROM PoliceCars
--WHERE model like '%1%'
-------------------------------- 
--insert into Usage(Tid,PCid,usage_date)
--values(1,7,'8-jan-2022'),(1,2,'8-jan-2022'),(2,3,'11-feb-2020'),(2,7,'8-sep-2022');
